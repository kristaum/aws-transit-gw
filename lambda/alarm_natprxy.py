# got from https://aws.amazon.com/blogs/security/how-to-add-dns-filtering-to-your-nat-instance-with-squid/
  ...
  for record in event['Records']:
    ...
    if message['NewStateValue'] == 'ALARM':
      ...
      for healthy_alarm in cw_client.describe_alarms(
        AlarmNamePrefix='FilteringNatInstanceProxy/',
        ActionPrefix='arn:aws:sns:us-east-1:349712507212:FilteringNatInstanceProxy-AlarmTopic-18F21HIHJKRRS',
        StateValue='OK'
      )['MetricAlarms']:
